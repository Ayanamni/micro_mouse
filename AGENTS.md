...
Every round, Codex reads only `项目维护协议.md` section 0.
...
- Runtime logs/results: read `gpt执行记录.md` if present.
...
- After each completed work block, prune completed or obsolete items from plan docs.
